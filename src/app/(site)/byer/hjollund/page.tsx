...
const cityConfig = CITY_PAGE_CONFIGS.find((city) => city.slug === "hjollund");

if (!cityConfig) {
  throw new Error("Missing city page config for hjollund");
}

export const metadata = buildCityPageMetadata(cityConfig);

export default function HjollundCityPage() {
