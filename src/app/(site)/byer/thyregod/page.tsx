...
const cityConfig = CITY_PAGE_CONFIGS.find((city) => city.slug === "thyregod");

if (!cityConfig) {
  throw new Error("Missing city page config for thyregod");
}

export const metadata = buildCityPageMetadata(cityConfig);

export default function ThyregodCityPage() {
